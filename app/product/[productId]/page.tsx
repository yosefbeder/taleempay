                ...
                <form onSubmit={handlePayment} className="space-y-6">
                  {isEditing && (
                    <div className="bg-yellow-50 p-3 rounded text-sm text-yellow-800 mb-4">
                      أنت تقوم بتعديل طلب موجود. سيتم تحديث بياناتك وإعادة إرسال الطلب للمراجعة.
                    </div>
                  )}
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                      ...
                      {product.paymentPhoneNumber && (
                        <div className="space-y-2">
                          <p className="text-sm text-gray-600">أرسل {product.price} جنيه إلى:</p>
                          ...
                          <div className="flex gap-2 text-xs text-gray-500">
                            {product.acceptsVodafoneCash && (
                              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">فودافون كاش</span>
                            )}
                            {product.acceptsInstapay && (
                              <span className="bg-purple-50 text-purple-700 px-2 py-1 rounded">انستا باي</span>
                            )}
                          </div>
                        </div>
                      )}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="screenshot">
                        {isEditing ? 'رفع إيصال جديد (اختياري)' : 'رفع إيصال الدفع'}
                      </Label>
                      <Input
                        id="screenshot"
                        name="screenshot"
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button type="submit" className={isEditing ? "flex-1" : "w-full"} disabled={uploading}>
                      {uploading ? (
                        <>
